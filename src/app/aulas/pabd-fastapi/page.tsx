          ...
          {current === 0 && (
            <LessonSection>
              <div className="pabd-hero">
                <div className="pabd-hero-badge">Informática - Programação com Acesso a Banco de Dados (PABD) - AULA 01</div>
                <h1>
          ...
          {current === 3 && (
            <LessonSection>
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <StepBlock num="01" title="Instalar httpx" defaultOpen>
...
uv add httpx`} />
                ...
                <StepBlock num="02" title="Primeiro teste: buscar CEP">
...
<span class="kw">with</span> httpx.<span class="fn">Client</span>() <span class="kw">as</span> client:
  ...
  <span class="str">"service"</span>: <span class="str">"open-cep"</span>
                ...
                <StepBlock num="03" title="Acessar o código de status da resposta">
          ...
          {current === 5 && (
            <LessonSection>
              <div style={{ marginTop: '1.5rem' }}>
                ...
                <StepBlock num="01" title="Importar HTTPException" defaultOpen>
                ...
                <StepBlock num="02" title="Endpoint: Buscar tarefa por ID (GET)">
...
<span class="kw">def</span> <span class="fn">buscar_tarefa</span>(id: <span class="cls">str</span>):
    ...
    <span class="kw">raise</span> <span class="fn">HTTPException</span>(status_code=<span class="num">404</span>, detail=<span class="str">"Tarefa não encontrada"</span>)`} />
                ...
                <StepBlock num="03" title="Endpoint: Editar tarefa (PUT)">
...
<span class="kw">def</span> <span class="fn">editar_tarefa</span>(id: <span class="cls">str</span>, dados: <span class="cls">TarefaEntrada</span>):
    ...
    <span class="kw">raise</span> <span class="fn">HTTPException</span>(status_code=<span class="num">404</span>, detail=<span class="str">"Tarefa não encontrada"</span>)`} />
                ...
                <StepBlock num="04" title="Endpoint: Remover tarefa (DELETE)">
